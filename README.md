...
Once the `conda-forge` channel has been enabled, `hyperts` can be installed with:

```
conda install hyperts
```

It is possible to list all of the versions of `hyperts` available on your platform with:
